...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-memalign-hack --target-os=mingw32 --enable-shared --disable-static --enable-gpl --enable-version3 --enable-pthreads --enable-runtime-cpudetect --enable-avisynth --enable-bzlib --enable-libvo-aacenc --enable-libx264 --enable-zlib
prefix=/usr/local
...
LN_S=ln -sf
STRIP=strip
CPPFLAGS=-I/local/include -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__
CFLAGS=   -std=c99 -fno-common -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=   -g
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS=-L/local/lib -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lavicap32 -lws2_32 -lx264 -lvo-aacenc -lavifil32 -lm -pthread -lpsapi 
INSTALL=install
LIBTARGET=i386
...
VCODEC_TESTS=amv asv1 asv2 avui cljr dnxhd_1080i dnxhd_720p dnxhd_720p_10bit dnxhd_720p_rd dv dv50 dv_411 error ffv1 ffvhuff flv h261 h263 h263p huffyuv jpeg2000 jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2_422 mpeg2_idct_int mpeg2_ilace mpeg2_ivlc_qprd mpeg2thread mpeg2thread_ilace mpeg4 mpeg4_adap mpeg4_qpel mpeg4_qprd mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 msvideo1 prores prores_kostya qtrle qtrlegray r210 rc rgb roq rv10 rv20 snow snowll svq1 v210 v308 v408 vref wmv1 wmv2 y41p yuv yuv4 
LAVF_FATE_TESTS=latm mp3 ogg_vp3 
LAVF_TESTS=aiff alaw asf au avi bmp caf dpx dv_fmt ffm flv_fmt gif gxf ismv jpg mkv mmf mov mpg mulaw mxf mxf_d10 nut ogg pam pbmpipe pcx pgm pgmpipe pixfmt ppm ppmpipe rm rso sgi sox sunrast swf tga tiff ts voc voc_s16 wav wtv xbm xwd yuv4mpeg 
LAVFI_TESTS=colormatrix1 colormatrix2 crop crop_scale crop_scale_vflip crop_vflip drawbox fade life null overlay pad pixdesc pixfmts_copy pixfmts_crop pixfmts_hflip pixfmts_null pixfmts_pad pixfmts_pixdesctest pixfmts_scale pixfmts_vflip pp pp2 pp3 pp4 pp5 pp6 scale200 scale500 select setdar setsar testsrc thumbnail transpose unsharp vflip vflip_crop vflip_vflip 
