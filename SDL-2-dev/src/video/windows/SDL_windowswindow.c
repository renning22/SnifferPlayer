...
WIN_SetWindowPosition(_THIS, SDL_Window * window)
{
	...
	// Ning modified for his selffish...
    /* Figure out what the window area will be */
	/*
    if ( (window->flags & SDL_WINDOW_FULLSCREEN) ||
	...
	*/
    ...
    x = window->x;
    y = window->y;
    SetWindowPos(hwnd, top, x, y, 0, 0, (SWP_NOCOPYBITS | SWP_NOSIZE | SWP_NOZORDER | SWP_NOSENDCHANGING));
}
...
WIN_SetWindowSize(_THIS, SDL_Window * window)
{
	...
	*/
	w = window->w;
	h = window->h;
    SetWindowPos(hwnd, top, 0, 0, w, h, (SWP_NOCOPYBITS | SWP_NOMOVE | SWP_NOZORDER | SWP_NOSENDCHANGING));
}
...
WIN_RaiseWindow(_THIS, SDL_Window * window)
{
    ...
    SetWindowPos(hwnd, top, 0, 0, 0, 0, (SWP_NOMOVE | SWP_NOSIZE | SWP_NOZORDER | SWP_NOSENDCHANGING));
}
...
WIN_SetWindowFullscreen(_THIS, SDL_Window * window, SDL_VideoDisplay * display, SDL_bool fullscreen)
{
    ...
    SetWindowPos(hwnd, top, x, y, w, h, SWP_NOCOPYBITS | SWP_NOZORDER | SWP_NOSENDCHANGING);
}
